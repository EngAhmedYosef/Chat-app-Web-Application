...
<body>
        ...
        if ($_GET['new'] == 'IS' || $_GET['new'] == 'CS') {
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save'])) {
                ...
                if (!empty($council_committee) && !empty($reference_no) && !empty($date)) {
                    ...
                    $sql = "INSERT INTO program_reports (user_id, council_committee, reference_no, date, program_id) 
            VALUES ('$user_id', '$council_committee', '$reference_no', '$date', '$program_id')";
                ...
                header("location: Annual_Program_Report_Approval_Of_Annual_Program_Report.php?new=" . $program_name);
                exit;
            }
            ...
            if (isset($_POST['homepage'])) {
                ...
                // unset($_SESSION['programs_new']);
                // unset($_SESSION['statistics_new']);
                // unset($_SESSION['kpis_new']);
                // unset($_SESSION['challenges_new']);
                // unset($_SESSION['plane_new']);
                // unset($_SESSION['annual_approval_new']);
                // unset($_SESSION['plos_new']);
                // unset($_SESSION['student_ev_new']);
                // unset($_SESSION['student_ev_q_new']);
                // unset($_SESSION['scientific_research_new']);
                // unset($_SESSION['community_partenership_new']);
                // unset($_SESSION['other_evaluation_new']);
                session_unset();
    ...
    ?>
                ...
                <div class="main">
                    ...
                    <form method="post" id="coursesForm">
                        ...
                        <div id="programs" class="form-container">
                            <h2><?= $translations['Approval Of Annual Program Report'] ?></h2>
                            <table>
                                <tr>
                            ...
                            <div class="navigation-buttons">
                                ...
                                <button type="button" class="nav-button" onclick="handleNavigation('Annual_Program_Report_Program_Devalopment_Plan.php?new=<?= $program_name ?>')">Back</button>
            ...
            if (isset($_GET['edit']) && ($_GET['edit'] == 'IS' || $_GET['edit'] == 'CS')) {
                ...
                if ($edit_item) {
                    $query = mysqli_query($conn, "SELECT * FROM program_reports WHERE id = '$edit_item' AND user_id = '$user_id'");
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update'])) {
                    ...
                    if (!empty($council_committee) && !empty($reference_no) && !empty($date)) {
                        ...
                        $update_sql = "UPDATE program_reports SET council_committee = '$council_committee', reference_no = '$reference_no', date = '$date' WHERE id = '$edit_item' AND user_id = '$user_id'";
                    ...
                    header("Location: Annual_Program_Report_Approval_Of_Annual_Program_Report.php?edit=" . $program_name);
                    exit;
                }
                ...
                if (isset($_POST['homepage'])) {
                    $user_id = $_SESSION['user_id'];
                    $lang = $_SESSION['lang'];
                    // unset($_SESSION['programs_edit']);
                    // unset($_SESSION['statistics_edit']);
                    // unset($_SESSION['kpis_edit']);
                    // unset($_SESSION['challenges_edit']);
                    // unset($_SESSION['plane_edit']);
                    // unset($_SESSION['annual_approval_edit']);
                    // unset($_SESSION['plos_edit']);
                    // unset($_SESSION['student_ev_edit']);
                    // unset($_SESSION['student_ev_q_edit']);
                    // unset($_SESSION['scientific_research_edit']);
                    // unset($_SESSION['community_partenership_edit']);
                    // unset($_SESSION['other_evaluation_edit']);
                    session_unset();
                    ...
                    <div class="main">
                        ...
                        <form method="post" id="coursesForm">
                            ...
                            <select name="edit_item" id="editSelect" style="width: 100px; height: 40px; border-radius: 5px;">
                                ...
                                $query = "SELECT * FROM program_reports WHERE program_id = '$program_id' AND user_id = '$user_id'";
                            ...
                            <div id="programs" class="form-container">
                                ...
                                <div class="navigation-buttons">
                                    ...
                                    <button type="button" class="nav-button" onclick="handleNavigation('Annual_Program_Report_Program_Devalopment_Plan.php?edit=<?= $program_name ?>')"><?= $translations['Back']?></button>
                                    <button type="submit" name="homepage" class="nav-button"><?= $translations['Home Page']?></button>
                                </div>
                            </div>
                        </form>
